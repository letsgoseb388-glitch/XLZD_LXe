...
def convert_h5_to_csv(h5_path: str, radius_mm: float, halfheight_mm: float, output_dir: str = "."):
    ...
    component = f"R{int(radius_mm)}_H{int(halfheight_mm)}"
...
if __name__ == "__main__":
    ...
    convert_h5_to_csv(args.h5_file, args.radius, args.halfheight, args.output_dir)
